...
const pages = [
  ...
  {
    path: "pages/selfMessage/updateSelf/updateSelf",
    style: {
  ...
  {
    path: "pages/mailToUserByQQ/mailToUserByQQ",
    style: {
      navigationBarTitleText: "QQ邮箱通知"
    }
  },
  {
    path: "pages/selfMessage/adminPageController/adminPageController",
    style: {
      navigationBarTitleText: "管理界面",
      navigationBarTextStyle: "black",
      navigationBarBackgroundColor: "#ffffff"
    }
  },
  {
    path: "pages/selfMessage/selfDataPage/selfDataPage",
    style: {
  ...
  {
    path: "pages/selfMessage/SetUpPage/SetUpPage",
    style: {
  ...
  {
    path: "pages/logDay/SelectUser/SelectUser",
    style: {
      navigationBarTitleText: "指定查看人",
      navigationBarTextStyle: "black",
      navigationBarBackgroundColor: "#b5b5b5"
    }
  },
  {
